...
.field public final mInitInternalFuture:Lcom/google/common/util/concurrent/ListenableFuture;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field public final mMinLogLevel:Ljava/lang/Integer;
...
# direct methods
.method public static synthetic $r8$lambda$TA_Qqr_qqcrvk98oeC1Ye3pw2tQ(Landroidx/camera/core/CameraX;Landroid/content/Context;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 0
...
.method public static synthetic $r8$lambda$dnuYhxGsACX_lH-9SVlUVTdtTJg(Landroidx/camera/core/CameraX;Landroid/content/Context;Ljava/util/concurrent/Executor;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;J)V
    .locals 0
...
.method public static synthetic $r8$lambda$rBIbGOUXygU0MV7yApaebqAdkqM(Landroidx/camera/core/CameraX;Ljava/util/concurrent/Executor;JLandroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
    .locals 0
...
.method public constructor <init>(Landroid/content/Context;Landroidx/camera/core/CameraXConfig$Provider;)V
    ...
    .line 134
    invoke-virtual {p0, p1}, Landroidx/camera/core/CameraX;->initInternal(Landroid/content/Context;)Lcom/google/common/util/concurrent/ListenableFuture;
...
.method private synthetic lambda$initAndRetryRecursively$1(Ljava/util/concurrent/Executor;JLandroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
    ...
    invoke-virtual/range {v0 .. v5}, Landroidx/camera/core/CameraX;->initAndRetryRecursively(Ljava/util/concurrent/Executor;JLandroid/content/Context;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
...
.method private synthetic lambda$initAndRetryRecursively$2(Landroid/content/Context;Ljava/util/concurrent/Executor;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;J)V
    ...
    .line 346
    invoke-virtual {p0}, Landroidx/camera/core/CameraX;->setStateToInitialized()V
...
.method public static updateOrResetMinLogLevel()V
    .locals 3
    .annotation build Landroidx/annotation/GuardedBy;
    .end annotation
...
.method public final initAndRetryRecursively(Ljava/util/concurrent/Executor;JLandroid/content/Context;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
    .locals 8
