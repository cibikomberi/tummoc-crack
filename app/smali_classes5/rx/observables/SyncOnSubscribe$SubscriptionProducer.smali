...
# virtual methods
.method public final doUnsubscribe()V
    .locals 2
...
.method public final fastPath()V
    .locals 3
    ...
    .line 406
    invoke-virtual {p0, v0}, Lrx/observables/SyncOnSubscribe$SubscriptionProducer;->nextIteration(Lrx/observables/SyncOnSubscribe;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 411
    invoke-virtual {p0}, Lrx/observables/SyncOnSubscribe$SubscriptionProducer;->tryUnsubscribe()Z
    ...
    .line 408
    invoke-virtual {p0, v1, v0}, Lrx/observables/SyncOnSubscribe$SubscriptionProducer;->handleThrownError(Lrx/Subscriber;Ljava/lang/Throwable;)V

    return-void
.end method

.method public final handleThrownError(Lrx/Subscriber;Ljava/lang/Throwable;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final nextIteration(Lrx/observables/SyncOnSubscribe;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public request(J)V
    ...
    .line 392
    invoke-virtual {p0}, Lrx/observables/SyncOnSubscribe$SubscriptionProducer;->fastPath()V

    goto :goto_0

    .line 394
    :cond_0
    invoke-virtual {p0, p1, p2}, Lrx/observables/SyncOnSubscribe$SubscriptionProducer;->slowPath(J)V
...
.method public final slowPath(J)V
    .locals 7
    ...
    .line 438
    invoke-virtual {p0, v1, p1}, Lrx/observables/SyncOnSubscribe$SubscriptionProducer;->handleThrownError(Lrx/Subscriber;Ljava/lang/Throwable;)V

    return-void
.end method

.method public final tryUnsubscribe()Z
    .locals 5
    ...
    .line 373
    invoke-virtual {p0}, Lrx/observables/SyncOnSubscribe$SubscriptionProducer;->doUnsubscribe()V
