...
.method public constructor <init>(I)V
    ...
    .line 55
    invoke-virtual {p0, p1}, Lrx/internal/util/atomic/SpscLinkedArrayQueue;->adjustLookAheadStep(I)V
...
.method public isEmpty()Z
    ...
    .line 212
    invoke-virtual {p0}, Lrx/internal/util/atomic/SpscLinkedArrayQueue;->lvProducerIndex()J

    move-result-wide v0

    invoke-virtual {p0}, Lrx/internal/util/atomic/SpscLinkedArrayQueue;->lvConsumerIndex()J
...
.method public final lvNext(Ljava/util/concurrent/atomic/AtomicReferenceArray;)Ljava/util/concurrent/atomic/AtomicReferenceArray;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final newBufferPoll(Ljava/util/concurrent/atomic/AtomicReferenceArray;JI)Ljava/lang/Object;
    ...
    .line 154
    invoke-virtual {p0, p2, p3}, Lrx/internal/util/atomic/SpscLinkedArrayQueue;->soConsumerIndex(J)V
...
.method public offer(Ljava/lang/Object;)Z
    ...
    .line 72
    invoke-virtual {p0}, Lrx/internal/util/atomic/SpscLinkedArrayQueue;->lpProducerIndex()J
    ...
    .line 76
    invoke-virtual/range {v0 .. v5}, Lrx/internal/util/atomic/SpscLinkedArrayQueue;->writeToQueue(Ljava/util/concurrent/atomic/AtomicReferenceArray;Ljava/lang/Object;JI)Z
    ...
    .line 87
    invoke-virtual/range {v0 .. v7}, Lrx/internal/util/atomic/SpscLinkedArrayQueue;->resize(Ljava/util/concurrent/atomic/AtomicReferenceArray;JILjava/lang/Object;J)V
...
.method public offer(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    .line 335
    invoke-virtual {p0, v4, v5}, Lrx/internal/util/atomic/SpscLinkedArrayQueue;->soProducerIndex(J)V
    ...
    .line 344
    invoke-virtual {p0, v0, v7}, Lrx/internal/util/atomic/SpscLinkedArrayQueue;->soNext(Ljava/util/concurrent/atomic/AtomicReferenceArray;Ljava/util/concurrent/atomic/AtomicReferenceArray;)V
...
.method public peek()Ljava/lang/Object;
    ...
    .line 168
    invoke-virtual {p0}, Lrx/internal/util/atomic/SpscLinkedArrayQueue;->lpConsumerIndex()J
    ...
    .line 173
    invoke-virtual {p0, v0}, Lrx/internal/util/atomic/SpscLinkedArrayQueue;->lvNext(Ljava/util/concurrent/atomic/AtomicReferenceArray;)Ljava/util/concurrent/atomic/AtomicReferenceArray;

    move-result-object v0

    invoke-virtual {p0, v0, v1, v2, v3}, Lrx/internal/util/atomic/SpscLinkedArrayQueue;->newBufferPeek(Ljava/util/concurrent/atomic/AtomicReferenceArray;JI)Ljava/lang/Object;
...
.method public poll()Ljava/lang/Object;
    ...
    .line 136
    invoke-virtual {p0, v1, v2}, Lrx/internal/util/atomic/SpscLinkedArrayQueue;->soConsumerIndex(J)V
    ...
    invoke-virtual {p0, v0, v1, v2, v3}, Lrx/internal/util/atomic/SpscLinkedArrayQueue;->newBufferPoll(Ljava/util/concurrent/atomic/AtomicReferenceArray;JI)Ljava/lang/Object;
...
.method public final resize(Ljava/util/concurrent/atomic/AtomicReferenceArray;JILjava/lang/Object;J)V
    ...
    .line 106
    invoke-virtual {p0, p1, v1}, Lrx/internal/util/atomic/SpscLinkedArrayQueue;->soNext(Ljava/util/concurrent/atomic/AtomicReferenceArray;Ljava/util/concurrent/atomic/AtomicReferenceArray;)V
    ...
    .line 109
    invoke-virtual {p0, p2, p3}, Lrx/internal/util/atomic/SpscLinkedArrayQueue;->soProducerIndex(J)V
...
.method public final writeToQueue(Ljava/util/concurrent/atomic/AtomicReferenceArray;Ljava/lang/Object;JI)Z
    ...
    .line 95
    invoke-virtual {p0, p3, p4}, Lrx/internal/util/atomic/SpscLinkedArrayQueue;->soProducerIndex(J)V
