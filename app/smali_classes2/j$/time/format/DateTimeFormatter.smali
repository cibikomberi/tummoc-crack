...
.method static constructor <clinit>()V
    ...
    invoke-virtual {v0, v1, v2, v3, v4}, Lj$/time/format/p;->l(Lj$/time/temporal/l;III)Lj$/time/format/p;
    ...
    invoke-virtual {v0, v6, v7}, Lj$/time/format/p;->k(Lj$/time/temporal/l;I)V

    invoke-virtual {v0, v5}, Lj$/time/format/p;->e(C)V

    sget-object v8, Lj$/time/temporal/a;->DAY_OF_MONTH:Lj$/time/temporal/a;

    invoke-virtual {v0, v8, v7}, Lj$/time/format/p;->k(Lj$/time/temporal/l;I)V

    sget-object v9, Lj$/time/chrono/h;->a:Lj$/time/chrono/h;

    const/4 v10, 0x1

    invoke-virtual {v0, v10, v9}, Lj$/time/format/p;->s(ILj$/time/chrono/h;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v11, v10, v9}, Lj$/time/format/p;->s(ILj$/time/chrono/h;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v11, v12, v7}, Lj$/time/format/p;->k(Lj$/time/temporal/l;I)V
    ...
    invoke-virtual {v11, v14, v7}, Lj$/time/format/p;->k(Lj$/time/temporal/l;I)V
    ...
    invoke-virtual {v11, v15, v7}, Lj$/time/format/p;->k(Lj$/time/temporal/l;I)V
    ...
    invoke-virtual {v11, v10, v13}, Lj$/time/format/p;->s(ILj$/time/chrono/h;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v7, v10, v13}, Lj$/time/format/p;->s(ILj$/time/chrono/h;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v7, v10, v9}, Lj$/time/format/p;->s(ILj$/time/chrono/h;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v0, v7, v11}, Lj$/time/format/p;->k(Lj$/time/temporal/l;I)V
    ...
    invoke-virtual {v0, v7, v2, v3, v4}, Lj$/time/format/p;->l(Lj$/time/temporal/l;III)Lj$/time/format/p;
    ...
    invoke-virtual {v0, v3, v4}, Lj$/time/format/p;->k(Lj$/time/temporal/l;I)V

    invoke-virtual {v0, v5}, Lj$/time/format/p;->e(C)V

    sget-object v3, Lj$/time/temporal/a;->DAY_OF_WEEK:Lj$/time/temporal/a;

    invoke-virtual {v0, v3, v10}, Lj$/time/format/p;->k(Lj$/time/temporal/l;I)V
    ...
    invoke-virtual {v0, v10, v4}, Lj$/time/format/p;->s(ILj$/time/chrono/h;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v0, v1, v2}, Lj$/time/format/p;->k(Lj$/time/temporal/l;I)V

    const/4 v4, 0x2

    invoke-virtual {v0, v6, v4}, Lj$/time/format/p;->k(Lj$/time/temporal/l;I)V

    invoke-virtual {v0, v8, v4}, Lj$/time/format/p;->k(Lj$/time/temporal/l;I)V
    ...
    invoke-virtual {v2, v8, v0, v3, v4}, Lj$/time/format/p;->l(Lj$/time/temporal/l;III)Lj$/time/format/p;
    ...
    invoke-virtual {v2, v1, v4}, Lj$/time/format/p;->k(Lj$/time/temporal/l;I)V

    invoke-virtual {v2, v0}, Lj$/time/format/p;->e(C)V

    invoke-virtual {v2, v12, v3}, Lj$/time/format/p;->k(Lj$/time/temporal/l;I)V

    const/16 v1, 0x3a

    invoke-virtual {v2, v1}, Lj$/time/format/p;->e(C)V

    invoke-virtual {v2, v14, v3}, Lj$/time/format/p;->k(Lj$/time/temporal/l;I)V
    ...
    invoke-virtual {v2, v1, v3}, Lj$/time/format/p;->k(Lj$/time/temporal/l;I)V
    ...
    invoke-virtual {v2, v3, v0}, Lj$/time/format/p;->s(ILj$/time/chrono/h;)Lj$/time/format/DateTimeFormatter;

    return-void
.end method

.method constructor <init>(Lj$/time/format/f;Ljava/util/Locale;ILj$/time/chrono/h;)V
    .locals 1
