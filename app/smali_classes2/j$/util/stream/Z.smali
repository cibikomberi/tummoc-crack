...
.method private synthetic constructor <init>(Lj$/util/stream/IntStream;)V
    ...
    iput-object p1, p0, Lj$/util/stream/Z;->a:Lj$/util/stream/IntStream;

    return-void
.end method

.method public static synthetic A(Lj$/util/stream/IntStream;)Lj$/util/stream/Z;
    .locals 1
    ...
    invoke-direct {v0, p0}, Lj$/util/stream/Z;-><init>(Lj$/util/stream/IntStream;)V
...
.method public final synthetic allMatch(Ljava/util/function/IntPredicate;)Z
    ...
    iget-object v0, p0, Lj$/util/stream/Z;->a:Lj$/util/stream/IntStream;
    ...
    .line 0
    :goto_0
    invoke-interface {v0, p1}, Lj$/util/stream/IntStream;->G(Lj$/util/function/b;)Z
...
.method public final synthetic anyMatch(Ljava/util/function/IntPredicate;)Z
    ...
    .line 0
    :goto_0
    invoke-interface {v0, p1}, Lj$/util/stream/IntStream;->D(Lj$/util/function/b;)Z
...
.method public final synthetic collect(Ljava/util/function/Supplier;Ljava/util/function/ObjIntConsumer;Ljava/util/function/BiConsumer;)Ljava/lang/Object;
    ...
    invoke-interface {v0, p1, p2, p3}, Lj$/util/stream/IntStream;->E(Lj$/util/function/Supplier;Lj$/util/function/B;Lj$/util/function/BiConsumer;)Ljava/lang/Object;
...
.method public final synthetic distinct()Ljava/util/stream/IntStream;
    ...
    invoke-static {v0}, Lj$/util/stream/Z;->A(Lj$/util/stream/IntStream;)Lj$/util/stream/Z;
...
.method public final synthetic findAny()Ljava/util/OptionalInt;
    ...
    invoke-static {v0}, Lj$/util/j;->c(Lj$/util/l;)Ljava/util/OptionalInt;
...
.method public final synthetic flatMap(Ljava/util/function/IntFunction;)Ljava/util/stream/IntStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/IntStream;->d0(Lj$/util/function/IntFunction;)Lj$/util/stream/IntStream;
...
.method public final synthetic forEach(Ljava/util/function/IntConsumer;)V
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/IntStream;->f0(Lj$/util/function/m;)V
...
.method public final synthetic forEachOrdered(Ljava/util/function/IntConsumer;)V
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/IntStream;->j0(Lj$/util/function/l;)V
...
.method public final synthetic iterator()Ljava/util/PrimitiveIterator$OfInt;
    ...
    invoke-static {v0}, Lj$/util/q;->a(Lj$/util/PrimitiveIterator$OfInt;)Lj$/util/q;
...
.method public final synthetic map(Ljava/util/function/IntUnaryOperator;)Ljava/util/stream/IntStream;
    ...
    .line 0
    :goto_0
    invoke-interface {v0, p1}, Lj$/util/stream/IntStream;->d(Lj$/util/function/b;)Lj$/util/stream/IntStream;
...
.method public final synthetic mapToDouble(Ljava/util/function/IntToDoubleFunction;)Ljava/util/stream/DoubleStream;
    ...
    .line 0
    :goto_0
    invoke-interface {v0, p1}, Lj$/util/stream/IntStream;->z(Lj$/util/function/b;)Lj$/util/stream/DoubleStream;
...
.method public final synthetic mapToLong(Ljava/util/function/IntToLongFunction;)Ljava/util/stream/LongStream;
    ...
    .line 0
    :goto_0
    invoke-interface {v0, p1}, Lj$/util/stream/IntStream;->h(Lj$/util/function/q;)Lj$/util/stream/LongStream;
...
.method public final synthetic mapToObj(Ljava/util/function/IntFunction;)Ljava/util/stream/Stream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/IntStream;->b0(Lj$/util/function/IntFunction;)Lj$/util/stream/Stream;
...
.method public final synthetic noneMatch(Ljava/util/function/IntPredicate;)Z
    ...
    .line 0
    :goto_0
    invoke-interface {v0, p1}, Lj$/util/stream/IntStream;->S(Lj$/util/function/b;)Z
...
.method public final synthetic peek(Ljava/util/function/IntConsumer;)Ljava/util/stream/IntStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/IntStream;->r(Lj$/util/function/l;)Lj$/util/stream/IntStream;
...
.method public final synthetic reduce(ILjava/util/function/IntBinaryOperator;)I
    ...
    .line 0
    :goto_0
    invoke-interface {v0, p1, p2}, Lj$/util/stream/IntStream;->x(ILj$/util/function/k;)I
...
.method public final synthetic reduce(Ljava/util/function/IntBinaryOperator;)Ljava/util/OptionalInt;
    ...
    .line 0
    :goto_0
    invoke-interface {v0, p1}, Lj$/util/stream/IntStream;->h0(Lj$/util/function/k;)Lj$/util/l;

    move-result-object p1

    invoke-static {p1}, Lj$/util/j;->c(Lj$/util/l;)Ljava/util/OptionalInt;
...
.method public final synthetic spliterator()Ljava/util/Spliterator$OfInt;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->spliterator()Lj$/util/y;
