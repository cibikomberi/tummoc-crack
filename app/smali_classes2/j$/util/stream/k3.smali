...
.method constructor <init>(Lj$/util/E;JJJJ)V
    ...
    iput-object p1, p0, Lj$/util/stream/k3;->c:Lj$/util/E;

    iput-wide p2, p0, Lj$/util/stream/k3;->a:J

    iput-wide p4, p0, Lj$/util/stream/k3;->b:J

    iput-wide p6, p0, Lj$/util/stream/k3;->d:J

    iput-wide p8, p0, Lj$/util/stream/k3;->e:J
...
.method protected abstract f(Lj$/util/E;JJJJ)Lj$/util/E;
.end method

.method public bridge synthetic trySplit()Lj$/util/A;
    .locals 1

    invoke-virtual {p0}, Lj$/util/stream/k3;->trySplit()Lj$/util/E;
...
.method public final trySplit()Lj$/util/E;
    ...
    iget-wide v7, p0, Lj$/util/stream/k3;->a:J

    cmp-long v0, v7, v13

    if-ltz v0, :cond_3

    iput-wide v13, p0, Lj$/util/stream/k3;->d:J

    goto :goto_0

    :cond_3
    iget-wide v9, p0, Lj$/util/stream/k3;->b:J

    cmp-long v0, v13, v9

    if-ltz v0, :cond_4

    iput-object v6, p0, Lj$/util/stream/k3;->c:Lj$/util/E;

    iput-wide v13, p0, Lj$/util/stream/k3;->e:J

    goto :goto_0

    :cond_4
    iget-wide v11, p0, Lj$/util/stream/k3;->d:J
    ...
    invoke-virtual/range {v5 .. v14}, Lj$/util/stream/k3;->f(Lj$/util/E;JJJJ)Lj$/util/E;
