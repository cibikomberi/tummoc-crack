...
.method constructor <init>(Lj$/util/stream/c;IJJ)V
    ...
    invoke-direct {p0, p1, p2}, Lj$/util/stream/x;-><init>(Lj$/util/stream/c;I)V

    return-void
.end method

.method static O1(Lj$/util/w;JJJ)Lj$/util/w;
    .locals 8
    ...
    invoke-direct/range {v2 .. v7}, Lj$/util/stream/l3;-><init>(Lj$/util/w;JJ)V
...
.method final E1(Lj$/util/E;Lj$/util/function/IntFunction;Lj$/util/stream/c;)Lj$/util/stream/y0;
    ...
    iget-wide v7, v9, Lj$/util/stream/h2;->u:J
    ...
    invoke-static {v6, v0, v10}, Lj$/util/stream/p0;->O0(Lj$/util/stream/p0;Lj$/util/E;Z)Lj$/util/stream/u0;
    ...
    iget-wide v1, v9, Lj$/util/stream/h2;->t:J

    iget-wide v3, v9, Lj$/util/stream/h2;->u:J

    move-wide v5, v7

    invoke-static/range {v0 .. v6}, Lj$/util/stream/h2;->O1(Lj$/util/w;JJJ)Lj$/util/w;

    move-result-object v0

    invoke-static {p0, v0, v10}, Lj$/util/stream/p0;->O0(Lj$/util/stream/p0;Lj$/util/E;Z)Lj$/util/stream/u0;
    ...
    iget-wide v7, v9, Lj$/util/stream/h2;->t:J

    iget-wide v11, v9, Lj$/util/stream/h2;->u:J
...
.method final F1(Lj$/util/stream/c;Lj$/util/E;)Lj$/util/E;
    ...
    invoke-direct/range {v7 .. v12}, Lj$/util/stream/d3;-><init>(Lj$/util/w;JJ)V
...
.method final H1(ILj$/util/stream/Z1;)Lj$/util/stream/Z1;
    ...
    invoke-direct {p1, p0, p2}, Lj$/util/stream/g2;-><init>(Lj$/util/stream/h2;Lj$/util/stream/Z1;)V
