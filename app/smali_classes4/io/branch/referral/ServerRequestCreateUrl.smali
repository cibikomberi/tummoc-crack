...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;IILjava/util/Collection;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lorg/json/JSONObject;Lio/branch/referral/Branch$BranchLinkCreateListener;ZZ)V
    ...
    iput-object p1, p0, Lio/branch/referral/ServerRequestCreateUrl;->linkPost_:Lio/branch/referral/BranchLinkData;

    .line 70
    :try_start_0
    sget-object p11, Lio/branch/referral/Defines$Jsonkey;->IdentityID:Lio/branch/referral/Defines$Jsonkey;
    ...
    invoke-virtual {p12}, Lio/branch/referral/PrefHelper;->getIdentityID()Ljava/lang/String;
    ...
    sget-object p11, Lio/branch/referral/Defines$Jsonkey;->DeviceFingerprintID:Lio/branch/referral/Defines$Jsonkey;
    ...
    invoke-virtual {p12}, Lio/branch/referral/PrefHelper;->getDeviceFingerPrintID()Ljava/lang/String;
    ...
    sget-object p11, Lio/branch/referral/Defines$Jsonkey;->SessionID:Lio/branch/referral/Defines$Jsonkey;
    ...
    invoke-virtual {p12}, Lio/branch/referral/PrefHelper;->getSessionID()Ljava/lang/String;
    ...
    invoke-virtual {p1, p3}, Lio/branch/referral/BranchLinkData;->putType(I)V

    .line 78
    iget-object p1, p0, Lio/branch/referral/ServerRequestCreateUrl;->linkPost_:Lio/branch/referral/BranchLinkData;

    invoke-virtual {p1, p4}, Lio/branch/referral/BranchLinkData;->putDuration(I)V

    .line 79
    iget-object p1, p0, Lio/branch/referral/ServerRequestCreateUrl;->linkPost_:Lio/branch/referral/BranchLinkData;

    invoke-virtual {p1, p5}, Lio/branch/referral/BranchLinkData;->putTags(Ljava/util/Collection;)V

    .line 80
    iget-object p1, p0, Lio/branch/referral/ServerRequestCreateUrl;->linkPost_:Lio/branch/referral/BranchLinkData;

    invoke-virtual {p1, p2}, Lio/branch/referral/BranchLinkData;->putAlias(Ljava/lang/String;)V

    .line 81
    iget-object p1, p0, Lio/branch/referral/ServerRequestCreateUrl;->linkPost_:Lio/branch/referral/BranchLinkData;

    invoke-virtual {p1, p6}, Lio/branch/referral/BranchLinkData;->putChannel(Ljava/lang/String;)V

    .line 82
    iget-object p1, p0, Lio/branch/referral/ServerRequestCreateUrl;->linkPost_:Lio/branch/referral/BranchLinkData;

    invoke-virtual {p1, p7}, Lio/branch/referral/BranchLinkData;->putFeature(Ljava/lang/String;)V

    .line 83
    iget-object p1, p0, Lio/branch/referral/ServerRequestCreateUrl;->linkPost_:Lio/branch/referral/BranchLinkData;

    invoke-virtual {p1, p8}, Lio/branch/referral/BranchLinkData;->putStage(Ljava/lang/String;)V

    .line 84
    iget-object p1, p0, Lio/branch/referral/ServerRequestCreateUrl;->linkPost_:Lio/branch/referral/BranchLinkData;

    invoke-virtual {p1, p9}, Lio/branch/referral/BranchLinkData;->putCampaign(Ljava/lang/String;)V

    .line 85
    iget-object p1, p0, Lio/branch/referral/ServerRequestCreateUrl;->linkPost_:Lio/branch/referral/BranchLinkData;

    invoke-virtual {p1, p10}, Lio/branch/referral/BranchLinkData;->putParams(Lorg/json/JSONObject;)V
...
.method public isDefaultToLongUrl()Z
    .locals 1
